...
import { Search, Filter, SlidersHorizontal, X, MapPin, Clock, Shield, ChevronDown } from 'lucide-react';
          ...
          <div className="flex gap-3 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
            <div className="relative shrink-0">
              <select
                ...
                className="appearance-none pl-3 pr-8 py-2 bg-background border border-border text-foreground rounded-lg text-sm font-medium focus:outline-none focus:border-primary cursor-pointer"
              >
