...
import { AlertType, ZoneType } from '@/lib/mock-data';
import { useSendAlert } from '@/hooks/use-api';
...
export default function SendAlert() {
  ...
  const [message, setMessage] = useState('A blackout condition has been detected. All personnel must immediately proceed to their designated muster points and await further instructions.');
  ...
  const handleSend = () => {
    if (confirm(`Are you sure you want to broadcast a ${type} alert to ${zone}?`)) {
      sendAlert.mutate({
        ...
        onSuccess: () => setLocation('/admin/alert-monitor')
      });
    }
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              {/* Message */}
              <div>
                <label className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3 block flex justify-between">
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-6 space-y-6">
            ...
            >
              {sendAlert.isPending ? "BROADCASTING..." : "BROADCAST ALERT"}
