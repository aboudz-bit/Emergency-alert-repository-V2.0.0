...
export function AdminLayout({ children, title, breadcrumbs }: { children: React.ReactNode, title?: string, breadcrumbs?: { label: string }[] }) {
    ...
    <div className="flex h-screen w-full bg-background overflow-hidden">
      ...
      >
        ...
        <div className="p-4 border-t border-border shrink-0">
          <Link href="/login" className="flex items-center px-3 py-3 rounded-lg text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
        ...
        <header className="h-16 bg-card/50 backdrop-blur-sm border-b border-border flex items-center justify-between px-8 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden md:block">
              <p className="text-sm font-semibold text-foreground">Ahmed Al-Qahtani</p>
