...
- **Store**: `keas-mobile-store-v20` (persist key), version 30 with slice architecture. Includes domain-specific slices, user management (approval status, user types), emergency-related state, and accountability session slice.
