...
- **Store**: `keas-mobile-store-v20` (persist key), version 28 with slice architecture. Includes domain-specific slices, user management (approval status, user types), and emergency-related state.
